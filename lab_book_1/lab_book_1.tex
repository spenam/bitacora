...
\labday{Jueves, 13 Marzo 2020}

\experiment{Changed the potential constants to $a=0.2$ and $b=0.01$}
...
\experiment{Little test with two oscillators}
...
\experiment{Little test with three oscillators}
...
\experiment{Well minima changes due to coupling with the oscillator}
...
\experiment{Experiment of different oscillators with different frequencies but same energy and the initial conditions on the buridans ass}
...
\experiment{Experiment with three oscillators}
